...
var G__5597 = o;
(G__5597[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__5599__i = 0, G__5599__a = new Array(arguments.length -  0);
while (G__5599__i < G__5599__a.length) {G__5599__a[G__5599__i] = arguments[G__5599__i + 0]; ++G__5599__i;}
  args = new cljs.core.IndexedSeq(G__5599__a,0,null);
} 
return G__5598__delegate.call(this,args);};
G__5598.cljs$lang$maxFixedArity = 0;
G__5598.cljs$lang$applyTo = (function (arglist__5600){
...
var G__5603 = jsprops;
(G__5603["defaultValue"] = value);

(G__5603["onChange"] = ((function (G__5603,v,value,on_change){
return (function (p1__5602_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5602_SHARP_);
});})(G__5603,v,value,on_change))
);
...
var vec__5606 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5606,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5606,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5606,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___5610 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___5610 == null)){
} else {
var key_5611 = temp__4661__auto___5610;
(jsprops["key"] = key_5611);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__5612 = reagent.impl.template.__GT_NativeWrapper();
(G__5612["name"] = c);
...
var G__5613 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5613) : reagent.impl.template.as_element.call(null,G__5613));
} else {
...
var len__4531__auto___5618 = arguments.length;
var i__4532__auto___5619 = (0);
while(true){
if((i__4532__auto___5619 < len__4531__auto___5618)){
args__4534__auto__.push((arguments[i__4532__auto___5619]));

var G__5620 = (i__4532__auto___5619 + (1));
i__4532__auto___5619 = G__5620;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5616){
var G__5617 = cljs.core.first(seq5616);
var seq5616__$1 = cljs.core.next(seq5616);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5617,seq5616__$1);
});
...
break;
default:
var G__5623 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__5623;
continue;
...
var n__4408__auto___5625 = a.length;
var i_5626 = (0);
while(true){
if((i_5626 < n__4408__auto___5625)){
(a[i_5626] = reagent.impl.template.as_element((a[i_5626])));

var G__5627 = (i_5626 + (1));
i_5626 = G__5627;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___5628 = a.length;
var i_5629 = (0);
while(true){
if((i_5629 < n__4408__auto___5628)){
var val_5630 = (a[i_5629]);
if(((cljs.core.vector_QMARK_(val_5630)) && ((reagent.impl.template.key_from_vec(val_5630) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5629] = reagent.impl.template.as_element(val_5630));
...
var ctx = ({});
var vec__5632 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5632,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5632,(1),null);
...
var G__5635 = (cljs.core.count(argv) - first_child);
switch (G__5635) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__5635){
